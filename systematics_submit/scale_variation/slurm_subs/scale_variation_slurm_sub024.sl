...
#SBATCH -C cpu
#SBATCH -t 1:00:00
#SBATCH -J qgtagging_scale_variation024
#SBATCH --qos=shared
#SBATCH --ntasks=1
...
/global/cfs/projectdirs/atlas/hrzhao/HEP_Repo/QG_Calibration/NewWorkflow/systematics_submit/scale_variation/make_histogram_scale_variation.sh 24
