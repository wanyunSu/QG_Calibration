...
#SBATCH -C cpu
#SBATCH -t 00:10:00
#SBATCH -J qgtagging_plot_scale_variation023
#SBATCH --qos=shared
#SBATCH --ntasks=1
...
/global/cfs/projectdirs/atlas/hrzhao/HEP_Repo/QG_Calibration/NewWorkflow/systematics_submit/scale_variation/make_plot_scale_variation.sh 23
