...
#SBATCH -C cpu
#SBATCH -t 1:00:00
#SBATCH -J qgtagging_pdf_weight017
#SBATCH --qos=shared
#SBATCH --ntasks=1
...
/global/cfs/projectdirs/atlas/hrzhao/HEP_Repo/QG_Calibration/NewWorkflow/systematics_submit/pdf_weight/make_histogram_pdf_weight.sh 17
