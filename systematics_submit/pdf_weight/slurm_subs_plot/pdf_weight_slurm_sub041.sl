...
#SBATCH -C cpu
#SBATCH -t 00:10:00
#SBATCH -J qgtagging_plot_pdf_weight041
#SBATCH --qos=shared
#SBATCH --ntasks=1
...
/global/cfs/projectdirs/atlas/hrzhao/HEP_Repo/QG_Calibration/NewWorkflow/systematics_submit/pdf_weight/make_plot_pdf_weight.sh 41
